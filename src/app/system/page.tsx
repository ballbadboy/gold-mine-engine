...
const SYSTEMS = [
  ...
  { name: 'Claude / Gemini / OR', status: 'pending', note: 'Check AI Status to verify configured providers' },
  { name: 'GA4', status: 'pending', note: 'Add service account viewer' },
  { name: 'OODA Loop', status: 'pending', note: 'Requires verified analytics input' },
] as const;
